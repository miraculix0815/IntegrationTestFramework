...
public class IntegrationTest {
  ...
  private void execute(Path source) throws IOException {
    ...
    System.out.println("---------------------------------------");
    System.out.println(" aus KUKA importiert       " + processedResult);
    System.out.println(" aus KUKA nach ABB konv.   " + convertedResult);
    System.out.println(" aus ABB import            " + processConvertedResult);
    System.out.println("---------------------------------------");
